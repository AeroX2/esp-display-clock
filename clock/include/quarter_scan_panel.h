...
void QuarterScanMatrixPanel::drawPixel(int16_t x, int16_t y, uint16_t color) {
  getCoords(x, y);
...
void QuarterScanMatrixPanel::drawPixelRGB888(int16_t x, int16_t y, uint8_t r, uint8_t g, uint8_t b) {
  getCoords(x, y);
  pixelData[x][y] = (r << 16) + (g << 8) + b;
